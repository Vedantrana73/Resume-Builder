    ...
    <div>
      ...
      <div className='flex flex-col lg:flex-row items-center justify-evenly'>
        ...
        <div className='lg:w-3/5'>
          ...
          <div className='text-center py-3 px-2 text-md md:text-lg lg:text-lg text-gray-600'>
          ...
          <div className='flex justify-center py-4'>
            <button className='btn rounded-box btn-outline text-lg'>Choose A Template</button>
          </div>
