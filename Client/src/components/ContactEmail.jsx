...
function ContactEmail() {
    const builders = [{name: 'Anuj Yadav', email: 'anujyadav@gmail.com'},{name: 'Akshat Gohil', email: 'akshatgohil@gmail.com'},{name: 'Vedant Rana', email:'vedantrana@gmail.com'},{name: 'Parth Patel', email: 'parthpatel@gmail.com'}]
  return (
