        ...
        <div className="mt-4">
          ...
          <section className="mt-4">
            ...
            <div className="mt-1 text-gray-600">
              <p>
                <strong>Phone:</strong> {resumeForm.contact.phone}
              </p>
              <p>
                <strong>Email:</strong> {resumeForm.contact.email}
              </p>
              <p>
                <strong>Address:</strong> {resumeForm.contact.address}
              </p>
            </div>
          </section>
          ...
          <section className="mt-4">
            ...
            <div className="flex flex-col flex-wrap text-gray-600 border h-32">
              {resumeForm.technicalSkills.map((skill) => (
                <div key={skill} className="w-full sm:w-1/2">
                  {skill}
                </div>
              ))}
            </div>
